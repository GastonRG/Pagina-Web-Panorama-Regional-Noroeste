...
<body class="grid-container">
	...
	<h1 class="primera">Noticias Internacionales</h1>
<aside class="sidebar">
		<div>
	...
	<article class="main">
		...
		<table  width="80%" border="0"  >
			...
			<?php
				...
				$query = "SELECT * FROM notauno WHERE lugar = 'internacionales' ORDER BY idnota DESC";
	...
	<footer class="footer">
		...
		<div class="fodiez">
				...
				<a class="founo" href="http://panoramaregionalvds.com/provinciales.php">Pprovinciales</a>
